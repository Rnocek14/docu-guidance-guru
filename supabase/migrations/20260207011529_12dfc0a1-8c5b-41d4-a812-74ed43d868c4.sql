...
-- Add cohort_phase = 'performance' guard to payout eligibility
-- This prevents Verification accounts from accidentally becoming payout-eligible
...
BEGIN
  ...
  -- *** NEW: Phase guard — only Performance accounts can request payouts ***
