...
DECLARE
  ...
  v_short    text;
BEGIN
  INSERT INTO cohorts (id, name, profit_target_percent, entry_fee, is_active)
  VALUES (gen_random_uuid(), '_pa_val_' || substr(md5(random()::text),1,6), 10, 149, false)
  ...
  -- 5g: public RPC requires the payout to be 'paid' or 'paid_confirmed' AND
  -- requires that the share is public. We set paid_confirmed above.
