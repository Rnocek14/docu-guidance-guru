...
-- ============================================================
-- FINAL HARDENING: claim + fulfill race-proof tightening
-- 1. claim: clear last_error, guard terminal statuses, COALESCE attempts
-- 2. fulfill: param match + require processing + catch unique_violation
-- 3. fulfill: ON CONFLICT DO NOTHING for payment_transactions
-- ============================================================
...
BEGIN
  ...
  -- Belt+suspenders: account already exists for this session
  ...
  -- 6. Mark queue fulfilled (clear processing state)
  UPDATE checkout_fulfillment_queue
  SET status = 'fulfilled',
