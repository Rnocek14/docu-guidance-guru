...
-- FIX: Profit buffer gate condition uses _has_prior_payout (lifetime)
-- instead of _is_first_payout_in_cycle (which resets to true after each cycle reset)
...
BEGIN
  ...
  -- FIX: Use _has_prior_payout (lifetime) instead of _is_first_payout_in_cycle
  -- because cycle resets after each paid payout make _is_first_payout_in_cycle
  -- always true, silently disabling this gate.
  -- ============================================================
