...
-- Fix: rename reason_code from COOLDOWN to COOLING_PERIOD for the post-pass cooling window
-- This distinguishes it from a future "post-payout cooldown" reason code
